...
public class HistoryOfResults extends Fragment {
    ...
    FragmentHistoryOfResultsBinding historyOfResultsBinding;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        historyOfResultsBinding = FragmentHistoryOfResultsBinding.inflate(inflater, container, false);
        // Inflate the layout for this fragment
        return historyOfResultsBinding.getRoot();
    }

    @Override
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        super.onViewCreated(view, savedInstanceState);
        historyOfResultsBinding.imageButton9.setOnClickListener(view2 -> goToBackScreen());
    }
